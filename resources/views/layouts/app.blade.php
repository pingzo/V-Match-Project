...
<head>
    ...
    <title>V Match Team Developer</title>
...
<body id="app-layout">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        <!--<li><a href="{{ url('/books') }}">รายการหนังสือ</a></li>-->
                    ...
                    @else
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="{{ url('/volunteer/'.Auth::user()->id.'/edit')}}">แก้ไขข้อมูลส่วนตัว</a></li>
                                <li><a href="{{ url('/schools'.Auth::user()->id.'/edit') }}">แก้ไขข้อมูลโรงเรียน</a></li>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.4/jquery.min.js"></script>
    ...
    <script src="{{ url('js/sweetalert.min.js') }}" type="test/javascript" ></script> 
